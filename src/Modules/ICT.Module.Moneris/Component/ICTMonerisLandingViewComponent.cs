...
namespace ICT.Module.Moneris.Component
{
    public class ICTMonerisLandingViewComponent : ViewComponent
    {
        ...
        public ICTMonerisLandingViewComponent(ICartService cartService, IWorkContext workContext, IRepositoryWithTypedId<PaymentProvider, string> paymentProviderRepository, ICurrencyService currencyService)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var model = new ICTMonerisCheckoutForm();
            //model.PublicKey = ICTMonerisSetting.PublicKey;
